...
import uia.dapp1.ejercicioencapsulamiento.Automovil;
...
public class StaticMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Automovil auto1 = new Automovil("Mazda", "CX3", 2022, 4, "Rojo", true, "automatica", 10000, 405000);
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    d = auto1.precioDescuento();
                    System.out.println("CON DESCUENTO: " + d);
